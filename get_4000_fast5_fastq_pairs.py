...
input_label_pairs_file = h5py.File("ga_4000_input_label_pairs.hdf5", "w")
...
# Let each of the 284 fastq file equally contribute 15 reads. 
...
for fastq in fastq_files:
	...
	random_sampler = random.sample(range(0, max_num_reads_in_file), 15)

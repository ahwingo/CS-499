...
#-----------------------------------------------------------------------------------------------------------------------------------
batch_size = 1100											# In paper, batch size is 1100
...
#  Train the model.  
#-----------------------------------------------------------------------------------------------------------------------------------
basecalling_model.fit(x = [training_inputs, input_lengths, training_label_shapes], y = training_labels, batch_size = batch_size, epochs = 1, verbose = 1, shuffle = "batch")
